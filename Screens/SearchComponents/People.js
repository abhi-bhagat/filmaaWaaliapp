 ...
 class People extends Component {
    ...
    render() {
        ...
        return (
            ...
            <CardItem cardBody>
              <Image source={{uri: `https://image.tmdb.org/t/p/original/${result.profile_path}`}} style={{height: 200, width: null, flex: 1}}/>
            </CardItem>
            <CardItem>
              
              <Body>
              <Text numberOfLines={4}>{result.known_for[0].overview}</Text>
              </Body>
